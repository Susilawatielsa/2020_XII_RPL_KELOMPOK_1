...
<div class="row pt-2 pb-2">
  <div class="col-sm-9">
    <h4 class="page-title">Daftar TU Ditolak</h4>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ url('dashboard')}}">SMK Mahaputra</a></li>
      <li class="breadcrumb-item"><a href="javaScript:void();">Kelola Petugas TU</a></li>
      <li class="breadcrumb-item active" aria-current="page">Daftar TU Ditolak</li>
    </ol>
  </div>
  <div class="col-sm-3">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  <a href="{{'/staffs/delete'}}" type="button" data-toggle="tooltip" data-placement="top" title="DELETE" class="btn btn-outline-danger waves-effect waves-light m-1"> <i class="fa fa-trash fa-lg"></i> </button>
                </td>
              </tr>
              <tr>
                <td>2</td>
