    ...
    <div class="container info-jurusan">
         ...
         <!-- info panel -->
                ...
                <div class="row workingspace">
                    <div class="container">
                    <h3 class="text-center font-weight-bold" style="color: #599be2; text-shadow: 1px 1px 1px blue; font-family: viga;">PROGRAM KEAHLIAN <br>SMK MAHAPUTRA CERDAS UTAMA</h3>
                    </div>
                    <div class="col-lg-6">
                        <img src="assets/images/4.jpg" class="img-fluid">
                        <a href="" style="color: #599be2;" ><b style="font-size: 20px;">REKAYASA PERANGKAT LUNAK</b></a>
                    </div>
                    <div class="col-lg-6">
                        <img src="assets/images/3.jpg"  class="img-fluid">
                        <a href="" style="color: #599be2;" ><b style="font-size: 20px;">MULTIMEDIA</b></a>
                    </div>
                </div>
                <!-- akhir info panel -->
