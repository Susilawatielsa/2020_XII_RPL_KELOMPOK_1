...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                <form id="signupForm" enctype="multipart/form-data" autocomplete="off" method="POST" action="" novalidate="novalidate">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" class="form-control" id="input-10" name="usr_nik" placeholder="Masukan Nomor NIK/KITAS">
                        </div>
                        <div class="col-sm-4">
